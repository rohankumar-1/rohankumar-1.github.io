...
const ProjectFPGA = () => {
    return (
        <Card className="proj">
            <Card.Title className="proj-title">Multimodal Clock using VGA and FPGA</Card.Title>
            <div className="proj-date">Dec 2022</div>
            <hr></hr>
            ...
            <Card.Body>
                <Card.Text className="proj-text">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <svg className="shield" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path fill="#000000" d="m8 18l5.241 6H5.586L.345 18l5.241-6L.345 6l5.241-6h7.655L8 6l5.241 6L8 18zM23.655 0H13.241l5.241 6l5.173-6zM13.241 24h10.414l-5.172-6l-5.242 6z"/>
                            </svg>
