...
const About = () => {
    ...
    return (
        <div className="first">
            ...
            <p className="text-start">
                I hope to eventually attend graduate school, and continue research, but I plan venture into industry at some point in the future. Feel free to reach out at <a href="mailto: roku@bu.edu">roku@bu.edu</a>.
            </p>
            ...
            <div className="more-info">Keep Scrolling for Projects...</div>
        </div>
    );
}
